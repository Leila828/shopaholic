...
class ReviewListView(BulkEditMixin, generic.ListView):
    model = ServiceReview
    template_name = 'dashboard/service/reviews/review_list.html'
...
class ReviewUpdateView(generic.UpdateView):
    model = ServiceReview
    template_name = 'dashboard/service/reviews/review_update.html'
...
class ReviewDeleteView(generic.DeleteView):
    model = ServiceReview
    template_name = 'dashboard/service/reviews/review_delete.html'
    context_object_name = 'review'

    def get_success_url(self):
        return reverse('Avis:reviews_list')
